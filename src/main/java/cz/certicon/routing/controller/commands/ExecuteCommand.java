...
/**
 *
 * @deprecated @author Michael Blaha {@literal <michael.blaha@certicon.cz>}
 */
...
//        RoutingAlgorithm routingAlgorithm = new AlgorithmCreateCommand().execute( new Quaternion<>( in.getAlgorithmType(), graph, graphEntityFactory, distanceFactory ) );
...
//                Pair<Coordinate, Coordinate> pair = in.getData().get( i );
//                try {
//                    Coordinate from = pair.a;
//                    Coordinate to = pair.b;
